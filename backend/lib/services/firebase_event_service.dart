...
class FirebaseEventService {
  ...
  static Event _toEvent(String eventId, Map<String, dynamic> doc) {
    return Event(
      ...
      cover_image_url: doc['cover_image_url'] as String? ?? '',
      date: doc['date'] as String? ?? '',
      start_time: doc['start_time'] as String? ?? '',
      end_time: doc['end_time'] as String? ?? '',
      event_mode: doc['event_mode'] as String? ?? '',
      location: doc['location'] as String?,
      stream_link: doc['stream_link'] as String?,
      host_name: doc['host_name'] as String? ?? '',
      guest_speaker: doc['guest_speaker'] as String?,
      ...
      is_open_to_guests: doc['is_open_to_guests'] as bool? ?? false,
